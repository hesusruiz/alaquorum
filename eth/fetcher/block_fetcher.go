...
func (f *BlockFetcher) Enqueue(peer string, block *types.Block) error {
	log.Info("JRM-BlockFetcher.Enqueue", "block", block.Number())
...
func (f *BlockFetcher) loop() {
	...
	for {
		...
		case notification := <-f.notify:
			...
			log.Info("JRM-BlockFetcher block announced", "block", notification.number)
...
func (f *BlockFetcher) rescheduleFetch(fetch *time.Timer) {
	...
	log.Info("JRM-rescheduleFetch", "delay", arriveTimeout-time.Since(earliest))
...
func (f *BlockFetcher) importBlocks(peer string, block *types.Block) {
	...
	go func() {
		...
		// Run the actual import and log any issues
		fmt.Printf("JRM-Fetcher before insertChain\n")
